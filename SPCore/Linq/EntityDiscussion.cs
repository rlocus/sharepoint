...
namespace SPCore.Linq
{
    ...
    [Serializable]
    public class EntityDiscussion : EntityFolder
    {
       ...
       private string _discussionSubject;
		...
		[Column(Name="DiscussionLastUpdated", Storage="_lastUpdated", ReadOnly=true, FieldType="DateTime")]
		public DateTime? LastUpdated {
			get {
				return this._lastUpdated;
			}
		 protected set {
		     if (value == this._lastUpdated) return;
		...
		public override string Name {
			get {
				throw new InvalidOperationException("Field FileLeafRef was removed from content type Discussion.");
			}
			set {
				throw new InvalidOperationException("Field FileLeafRef was removed from content type Discussion.");
			}
