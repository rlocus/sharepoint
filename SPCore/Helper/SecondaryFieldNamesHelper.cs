...
// * Title: SecondaryFieldNamesHelper
...
//        {
//            return (((nIndex + 2) < nPathLength) && (str[nIndex] == '%')) &&
//                   (IsHexDigit(str[nIndex + 1]) && IsHexDigit(str[nIndex + 2])) &&
//                   (str[nIndex + 1] != '0' || str[nIndex + 2] != '0');
//        }
...
//        {
//            if (!string.IsNullOrEmpty(keyOrValueToEncode) && (output != null))
//            {
//                int startIndex = 0;
//                int length = 0;
...
//            const int num3 = 240;
//            const int num4 = 0x80;
//            const int num5 = 0xd800;
//            const int num6 = 0xfc00;
//            const int num7 = 0x10000;
//            fUsedNextChar = false;
//            int index = ch;
