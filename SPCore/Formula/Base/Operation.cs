...
namespace SPCore.Formula.Base
{
    ...
    class Operation
    {
        private static readonly Dictionary<ComparisonOperation, string> ComparisonOperators = new Dictionary<ComparisonOperation, string>()
        {
        ...
        private static readonly Dictionary<UnaryOperation, string> UnaryOperators = new Dictionary<UnaryOperation, string>()
        {
            {UnaryOperation.Minus, "-"},
        };

        private static readonly Dictionary<BinaryOperation, string> BinaryOperators = new Dictionary<BinaryOperation, string>()
        {
